  ...
  phases: [
    {
      ...
      focus: ['kubelet', 'pod-static'], labels: ['kubelet', 'pod-static'],
      cam: [6.0, 0, 0], dist: 28,
      set: {
      ...
      scene(a) {
        ...
        KIT.note(a, 'DaemonSet ≠ miễn nhiễm', [8.4, -3.4, 3.0], 'warn', 0.9);
      }
    },
    {
      ...
      scores: usageRows,
      scene(a) {
        KIT.note(a, 'requests = 0 → mọi byte đều là "vượt"', [0.6, -3.4, 3.0], 'danger', 0.8);
      }
    },
    {
      ...
      scene(a) {
        ...
        KIT.note(a, 'PDB không được hỏi ý kiến ở đây', [1.5, -3.4, 3.0], 'warn', 1.2);
      }
    }
  ]
}
    ...
    phases: [
      {
        ...
        scene(a) {
          ...
          KIT.note(a, 'Evicted ≠ OOMKilled', [-13.0, -3.4, -1.0], 'danger', 1.0);
        }
      },
      {
        ...
        scene(a) {
          ...
          KIT.note(a, 'grace ' + run.threshold.podGracePeriodSeconds + 's ≠ tức thời', [8.4, -3.4, 3.0], 'danger', 1.2);
        }
      },
      {
        ...
        scene(a) {
          ...
          KIT.note(a, 'một victim / cycle · cách nhau ~' + config.monitoringPeriodSeconds + 's', [2.5, -3.4, 3.0], 'warn', 0.9);
        }
      }
    ]
  });
